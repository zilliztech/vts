...
> migrate data from milvus to milvus
...
| collections | List   | No       | -       | If set, will only read collections in the list, otherwise will read all collections under database. |
...
| partition_key        | String  | No       | No                           | Milvus partition key field                                |
| create_index         | boolean | No       | false                        | If create index from source milvus                        |
