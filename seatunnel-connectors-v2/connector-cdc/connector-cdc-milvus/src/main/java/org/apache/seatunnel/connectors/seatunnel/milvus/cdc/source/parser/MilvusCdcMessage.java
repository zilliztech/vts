...
@Getter
public abstract class MilvusCdcMessage {
    private final MilvusCdcMessageKind kind;
    private final MilvusCdcOffset offset;

    protected MilvusCdcMessage(MilvusCdcMessageKind kind, MilvusCdcOffset offset) {
        this.kind = kind;
        this.offset = offset;
    }

    public boolean shouldCheckpoint() {
        return offset != null && kind.shouldCheckpoint();
    }
}
