...
public class MilvusCdcSourceFactory implements TableSourceFactory {

    @Override
    public <T, SplitT extends SourceSplit, StateT extends Serializable>
            TableSource<T, SplitT, StateT> createSource(TableSourceFactoryContext context) {
        return () -> (SeaTunnelSource<T, SplitT, StateT>) new MilvusCdcSource(context.getOptions());
    }
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .required(
                        ...
                        MilvusCdcSourceConfig.DATABASE_COLLECTIONS,
                        MilvusCdcSourceConfig.CHANNEL_POSITIONS)
                .optional(
                        MilvusCdcSourceConfig.MESSAGE_TYPES,
                        MilvusCdcSourceConfig.STARTUP_MODE,
                        MilvusCdcSourceConfig.QUEUE_CAPACITY,
