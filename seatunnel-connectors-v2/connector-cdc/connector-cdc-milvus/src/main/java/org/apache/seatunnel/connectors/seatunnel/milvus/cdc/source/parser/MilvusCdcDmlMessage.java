...
@Getter
public class MilvusCdcDmlMessage extends MilvusCdcMessage {
    private final MilvusCdcMessageType messageType;
    private final List<MilvusCdcRecord> records;
    private final boolean transactional;

    public MilvusCdcDmlMessage(
            MilvusCdcOffset offset,
            MilvusCdcMessageType messageType,
            List<MilvusCdcRecord> records,
            boolean transactional) {
        super(MilvusCdcMessageKind.DML, offset);
        this.messageType = messageType;
        this.records =
                records == null ? Collections.emptyList() : Collections.unmodifiableList(records);
