...
public class TablePathTransformFactory implements TableTransformFactory {
    @Override
    ...
    public OptionRule optionRule() {
        return OptionRule.builder()
                .optional(TablePathMapperTransformConfig.TABLE_MAPPER)
                .optional(TablePathMapperTransformConfig.DATABASE_MAPPER)
                .optional(TablePathMapperTransformConfig.SCHEMA_MAPPER)
                .build();
    }
